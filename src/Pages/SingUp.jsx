...
function SingUp() {
    ...
    return (
        <div className="max-w-md p-6 bg-white rounded shadow-2xl border-2 py-10 my-32 mx-auto m-5">
            ...
            <div className="flex justify-between">
                <button onClick={handleGoogleSingUp} className="flex items-center gap-3  text-black border border-yellow-500 font-bold py-2 px-4 rounded" >
                ...
                <button className="flex items-center gap-3  text-black border border-yellow-500 font-bold py-2 px-4 rounded" >
